...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', type=str, default='DataShield', choices=['DataShield'])
    ...
    model_id = args.model_name_or_path or MODEL_PATH_MAP[args.model_family]
    print(model_id)
    ...
    print("="*50)
    print(f"Number of records in the original JSON file: {len(train_ds)}")    
    print("="*50)
